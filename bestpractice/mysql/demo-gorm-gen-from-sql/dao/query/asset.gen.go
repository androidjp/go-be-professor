...
import (
	...
	"demo-gorm-gen-from-sql/dao/model"
)
...
func newAsset(db *gorm.DB, opts ...gen.DOOption) asset {
	...
	_asset.Key = field.NewString(tableName, "key")
	_asset.Alias_ = field.NewString(tableName, "alias")
	_asset.Desc = field.NewString(tableName, "desc")
	_asset.Type = field.NewInt32(tableName, "type")
...
type asset struct {
	...
	ALL    field.Asterisk
	ID     field.String // 主键
	Key    field.String // 资产的唯一标识key
	Alias_ field.String // 别名：中文名等
	Desc   field.String // 对资源的描述
	Type   field.Int32  // 资源的类型
